del *.cat
"c:\Program Files (x86)\Windows Kits\10\Tools\10.0.22621.0\x86\infverif.exe" /v /u ahpbootloader.inf
...
"c:\Program Files (x86)\Windows Kits\10\bin\10.0.22621.0\x86\signtool.exe" sign /f ..\..\codesign.pfx /p password /fd sha256 /t http://timestamp.sectigo.com ahpbootloader.cat
